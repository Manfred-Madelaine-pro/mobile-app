...
class Zoom(ScatterLayout):
    ...
    def transform_with_touch(self, touch):
        ...
        if len(self._touches) == self.translation_touches:
            ...
            if (
                    touch.x > left and touch.x < right and touch.y < top and touch.y > bottom or self.move_lock) and \
                    not self.scale_lock_left and not self.scale_lock_right and not self.scale_lock_top and not \
                    self.scale_lock_bottom:
                self.move_lock = True
